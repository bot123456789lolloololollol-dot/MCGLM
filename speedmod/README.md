...
The 1.05x value is intended to be a small movement adjustment. Expected
numbers: walk 4.317 -> ~4.53 b/s, sprint 5.612 -> ~5.89 b/s (sprint's +30%
...
`SPEED_MULTIPLIER = 0.05` is the current value.
